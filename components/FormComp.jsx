...
const FormComp = () => {
  ...
  return (
    <div className={"bg-background2 flex items-center relative h-fit p-16  -z-10  bg-cover bg-center"}>
      <div className={"flex flex-col space-y-8 md:flex-row justify-between w-full items-center"}>
        ...
        <div className={`bg-[#0c0a09]/70 rounded-md p-5 flex flex-col w-full  space-y-8 mx-8 items-center text-center md:text-left 
          md:w-2/5 md:mx-12 md:space-y-4` }>
            <h1 className="text-white text-4xl md:text-5xl text-center w-full">Ajánlatkérés</h1>
            <hr className="border-2 w-1/3  border-[#C79753] border-solid"/>
      ...
      <div className={`text-sm fixed px-6 py-6 right-0 pr-28 drop-shadow-2xl bottom-16 z-40 text-center bg-[#EAC76D] 
