    ...
    <div className='block bg-gradient-to-b from-[#DBB164] to-[#C79753]' >
      ...
      <div className="flex p-20 items-center space-y-16 flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 items-center justify-between gap-8 " ref={divRef}>
          <Link href={"https://kertvill-centrum.hu/"} target="_blank"><Image src={kertvill} width={200}/></Link>
          <Link href={"https://femdekor.hu/"} target="_blank"><Image src={femdekor} width={200}/></Link>
          <Link href={"https://www.overgate.hu/"} target="_blank"><Image src={overgate} width={200}/></Link>
          <Link href={"https://www.facebook.com/godorelectric/"} target="_blank"><Image src={godor} width={200}/></Link>
          <Link href={"https://nyilaszarokereskedes.hu/"} target="_blank"><Image src={alfa} width={200}/></Link>
        </div>
      </div>
    </div>
  )
